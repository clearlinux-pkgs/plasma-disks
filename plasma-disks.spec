...
Version  : 6.3.2
Release  : 23
URL      : https://download.kde.org/stable/plasma/6.3.2/plasma-disks-6.3.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.2/plasma-disks-6.3.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.2/plasma-disks-6.3.2.tar.xz.sig
...
%setup -q -n plasma-disks-6.3.2
cd %{_builddir}/plasma-disks-6.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741242104
mkdir -p clr-build
pushd clr-build
