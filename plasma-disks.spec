...
Version  : 6.2.4
Release  : 18
URL      : https://download.kde.org/stable/plasma/6.2.4/plasma-disks-6.2.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.4/plasma-disks-6.2.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.4/plasma-disks-6.2.4.tar.xz.sig
...
%setup -q -n plasma-disks-6.2.4
cd %{_builddir}/plasma-disks-6.2.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735335929
mkdir -p clr-build
pushd clr-build
