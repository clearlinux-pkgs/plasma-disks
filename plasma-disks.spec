...
Source0  : https://download.kde.org/stable/plasma/6.3.5/plasma-disks-6.3.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.5/plasma-disks-6.3.5.tar.xz.sig
...
%setup -q -n plasma-disks-6.3.5
cd %{_builddir}/plasma-disks-6.3.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747237841
mkdir -p clr-build
pushd clr-build
